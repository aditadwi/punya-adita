...
input.<br><br> 
    ...
    <div class="d-flex aligns-items-center justify-content-center"> 
        ...
        <div class="col-lg-6 ps-3"> 
            <div class="card"> 
                <div class="card-header">Kudapan </div> 
                <div class="card-body"> 
                    <form wire:submit.prevent="store" method="POST">  
                        ...
                        <div class=" card-body"> 
                            ...
                            <div class="form-group"> 
                                <label for="kudapan_id">Kudapan</label> 
                                <select class="form-control" wire:model="kudapan_id" name="kudapan_id"> 
                                    <option hidden>--Pilih Kudapan-</option> 
                                    @foreach($dataKudapan as $dt ) 
                            ...
                            <div class="form-group"> 
                                ...
                                <input type="number" class="form-control" wire:model="jumlah" name="jumlah"> 
                    ...
                    <table class="table table-sm"> 
                        ...
                        <tbody> 
                            ...
                            <tr> 
                                ...
                                <td>{{ $dt->kudapan->name }}</td> 
                                <td>@money($dt->harga)</td> 
                                <td>{{ $dt->jumlah}}</td> 
                                <td>@money($dt->harga * $dt->jumlah)</td>                                 
                                <td><button class="btn btn-sm btn-danger" wire:click="delete({{ $dt->id }})">
