...
<body class="hold-transition login-page" style="background-image: url(dwi.jpg); background-size: outo"> 
<div class="login-box"> 
  <!-- /.login-logo --> 
  <div class="card card-outline card-primary"> 
    <div class="card-header text-center"> 
      <h1 class="h1">Aplikasi<b>POSADITA</b></h1> 
    </div> 
    <div class="card-body"> 
      <p class="login-box-msg">Please Login Untuk Masuk</p> 
