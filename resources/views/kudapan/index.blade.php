...
<div class="card card-info"> 
        <div class="card-header"> 
            ...
            <a type="button" class="btn btn-success float-right" href="{{ route('kudapan.create') }}"> 
                <i class=" fas fa-plus"></i> Tambah Kudapan
            </a> 
        </div> 
        <!-- /.card-header --> 
            ...
            <table id="example1" class="table table-bordered table-striped "> 
                ...
                <tbody> 
                    ...
                    <tr> 
                        ...
                        <td> 
                            <div class="btn-group"> 
                                <form action="{{ route('kudapan.destroy',$dt->id)}}" method="POST"> 
                                    @csrf 
                                    @method('DELETE') 
                                ...
                                <a type="button" class="btn btn-warning" href="{{ route('kudapan.edit',$dt->id) }}"> 
                                    <i class=" fas fa-edit"></i> 
                                </a> 
                                <a type="button" class="btn btn-success" href="{{ route('kudapan.show',$dt->id) }}"> 
