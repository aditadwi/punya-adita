...
<div class="container-fluid">
    ...
    <!-- =========================================================== -->
    <h1 class="h3 mb-1">
        <strong>Kudapan</strong> Tercatat
    </h1>
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Ringan</span>
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box shadow-lg">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Kudapan</span>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box bg-gradient-warning">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Kudapan</span>
                        <span class="info-box-number">{{$kudapan}}</span>
